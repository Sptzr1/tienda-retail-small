...
export default function Cart({ items, updateQuantity, removeItem, clearCart, storeId, storeName }) {
  ...
  console.log("Cart received storeId:", storeId); // Confirmar que llega como 1
  ...
  const handleCheckout = async () => {
    ...
    // Validar storeId justo antes de usarlo
    ...
    try {
      ...
      // Crear el objeto de datos explícitamente y loggearlo
      const orderData = {
        total_amount: total,
        tax_amount: tax,
        status: "completed",
        store_id: Number(storeId), // Asegurar que sea un número
      };
      console.log("Data sent to Supabase:", orderData);
      ...
      // Configurar la orden completada para el recibo
      setCompletedOrder({
        ...order,
      ...
      <div className="flex flex-col h-full">
        <div className="p-4 border-b flex justify-between items-center">
          ...
          <div className="flex space-x-2">
            <button onClick={handlePrint} className="p-2 text-gray-600 hover:text-gray-900">
        ...
        <div className="flex-1 overflow-auto p-4">
          <div className="max-w-md mx-auto bg-white p-6 border rounded-lg print:border-none print:shadow-none">
            <div className="text-center mb-6">
              <h3 className="text-xl font-bold">{completedOrder.store.name}</h3>
              <p className="text-gray-500 text-sm">Recibo de compra</p>
...
export default function Cart({ items, updateQuantity, removeItem, clearCart, storeId, storeName }) {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      console.log("Data sent to Supabase (orders):", orderData);
      ...
      console.log("Data sent to Supabase (order_items):", orderItems);
    ...
    frameWindow.document.write(`
      <html>
        ...
        <body>
          ...
          <div class="info">
            <div>Orden #: ${completedOrder.id}</div>
