...
export default function SalesReport({ profile, stores, storeId, isDemo }) {
    ...
    try {
      ...
      if (profile.role === "super_admin" || (profile.role === "demo" && profile.demo_view_privilege === "super_admin")) {
        ...
        if (storesError || !assignedStores || assignedStores.length === 0) {
          throw new Error("No stores assigned");
        }
    ...
    <div>
      ...
      <form onSubmit={handleApplyFilters} className="mb-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          {(profile.role === "super_admin" || (profile.role === "demo" && profile.demo_view_privilege === "super_admin") || 
            profile.role === "manager" || (profile.role === "demo" && profile.demo_view_privilege === "manager")) && (
            <div>
